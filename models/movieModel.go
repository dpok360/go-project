...
type Genre struct {
	GenreID   int    `bson:"genre_id" json:"genre_id" valid:"required"`
	GenreName string `bson:"genre_name" json:"genre_name" valid:"required min=2 , max=100"`
}

type Ranking struct {
	RankingValue int    `bson:"ranking_value" json:"ranking_value" valid:"required"`
	RankingName  string `bson:"ranking_name" json:"ranking_name" valid:"required"`
}
type Movie struct {
